...
substitutions in EditSource += sub("""pathPrefix: .*$""".r, "pathPrefix: \"{{ cookiecutter._class_dir }}/reader/grammars/{{ cookiecutter.project_name }}\"")
...
{% set class_list = cookiecutter._class_dir.split('/') %}
