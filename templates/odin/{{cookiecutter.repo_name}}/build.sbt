...
substitutions in EditSource += sub("""pathPrefix: .*$""".r, "pathPrefix: \"{{ cookiecutter.class_dir }}/reader/grammars/{{ cookiecutter.project_name }}\"")
...
{% set class_list = cookiecutter.class_dir.split('/') %}
